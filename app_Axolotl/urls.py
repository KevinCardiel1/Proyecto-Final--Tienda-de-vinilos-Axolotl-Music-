...
urlpatterns = [
    ...
    path('admin_panel/clientes/agregar/', views.agregar_cliente, name='agregar_cliente'),
    ...
    # Compatibilidad con URLs estándar de django.contrib.auth
    path('accounts/login/', views.login_frontend, name='accounts_login_redirect'),
    path('accounts/logout/', views.logout_view, name='accounts_logout_redirect'),
